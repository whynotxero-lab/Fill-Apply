...
| jsdom test suites | ✅ | `npm test` — 11 suites (includes adaptive knowledge, JobPool status, run modes, backend POST) |
...
*Last reviewed against repo at v1.16.0 (adaptive applicant knowledge).*
