/**
 * Hays adapter (agency) — Thin detect stub — fill delegates to fallback heuristics. Boards often redirect into an ATS adapter at apply time.
 */
(function (global) {
  'use strict';

  var HOSTS = ['hays.com', 'www.hays.com'];
  var HOST_RE = /hays\.com/i;
  ...
  var adapter = {
    ...
    fill: function (ctx) {
      ...
      if (!fb) {
        return { ok: false, adapterId: 'hays', error: 'Fallback adapter missing', filled: 0, unmatched: 0, total: 0 };
      }
