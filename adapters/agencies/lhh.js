/**
 * LHH adapter (agency) — Thin detect stub — fill delegates to fallback heuristics. Boards often redirect into an ATS adapter at apply time.
 */
(function (global) {
  'use strict';

  var HOSTS = ['lhh.com', 'www.lhh.com'];
  var HOST_RE = /lhh\.com/i;
  ...
  var adapter = {
    ...
    fill: function (ctx) {
      ...
      if (!fb) {
        return { ok: false, adapterId: 'lhh', error: 'Fallback adapter missing', filled: 0, unmatched: 0, total: 0 };
      }
