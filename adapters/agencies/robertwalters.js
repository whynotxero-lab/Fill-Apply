/**
 * Robert Walters adapter (agency) — Thin detect stub — fill delegates to fallback heuristics. Boards often redirect into an ATS adapter at apply time.
 */
(function (global) {
  'use strict';

  var HOSTS = ['robertwalters.com', 'www.robertwalters.com'];
  var HOST_RE = /robertwalters\.com/i;
  ...
  var adapter = {
    ...
    fill: function (ctx) {
      ...
      if (!fb) {
        return { ok: false, adapterId: 'robertwalters', error: 'Fallback adapter missing', filled: 0, unmatched: 0, total: 0 };
      }
      return fb.fill(Object.assign({}, ctx, {
        adapterId: 'robertwalters',
