/**
 * eFinancialCareers adapter (board) — Thin detect stub — fill delegates to fallback heuristics. Boards often redirect into an ATS adapter at apply time.
 */
(function (global) {
  'use strict';

  var HOSTS = ['efinancialcareers.com'];
  ...
  var adapter = {
    ...
    fill: function (ctx) {
      ...
      if (!fb) {
        return { ok: false, adapterId: 'efinancialcareers', error: 'Fallback adapter missing', filled: 0, unmatched: 0, total: 0 };
      }
