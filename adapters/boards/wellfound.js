/**
 * Wellfound adapter (board) — Thin detect stub — fill delegates to fallback heuristics. Boards often redirect into an ATS adapter at apply time.
 */
(function (global) {
  'use strict';

  var HOSTS = ['wellfound.com', 'angel.co', 'talent.wellfound.com'];
  var HOST_RE = /wellfound\.com|angel\.co/i;
  ...
  var adapter = {
    ...
    fill: function (ctx) {
      ...
      if (!fb) {
        return { ok: false, adapterId: 'wellfound', error: 'Fallback adapter missing', filled: 0, unmatched: 0, total: 0 };
      }
