/**
 * FlexJobs adapter (board) — Thin detect stub — fill delegates to fallback heuristics. Boards often redirect into an ATS adapter at apply time.
 */
(function (global) {
  'use strict';

  var HOSTS = ['flexjobs.com', 'www.flexjobs.com'];
  var HOST_RE = /flexjobs\.com/i;
  ...
  var adapter = {
    ...
    fill: function (ctx) {
      ...
      if (!fb) {
        return { ok: false, adapterId: 'flexjobs', error: 'Fallback adapter missing', filled: 0, unmatched: 0, total: 0 };
      }
