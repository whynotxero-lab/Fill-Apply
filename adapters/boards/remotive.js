/**
 * Remotive adapter (board) — Thin detect stub — fill delegates to fallback heuristics. Boards often redirect into an ATS adapter at apply time.
 */
(function (global) {
  'use strict';

  var HOSTS = ['remotive.com', 'remotive.io'];
  var HOST_RE = /remotive\.(com|io)/i;
  ...
  var adapter = {
    ...
    fill: function (ctx) {
      ...
      if (!fb) {
        return { ok: false, adapterId: 'remotive', error: 'Fallback adapter missing', filled: 0, unmatched: 0, total: 0 };
      }
