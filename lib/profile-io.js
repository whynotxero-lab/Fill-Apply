      ...
      var rawVal =
        cleaned.value != null
          ...
          : cleaned.displayValue != null
            ...
            : '';
      // Empty shells stay empty — fill skips them (never invent).
      out.push({
        ...
        confidence: normalizeImportConfidence(cleaned.confidence),
        status: normalizeImportStatus(cleaned.status),
