 ...
 *   3. confirmed user knowledge (Tier 2) — non-identity
 *   4. remaining profile / built-in field-map / customAnswers / customQA
...
(function (global) {
  ...
  function resolve(profile, descriptor, map) {
    ...
    // Non-identity keys (notice period, screening, etc.) keep confirmed adaptive above profile.
    if (identified && identified.key) {
      var idPkEarly =
