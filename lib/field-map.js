...
(function (global) {
  ...
  const FIELD_MAP = [
    ...
    },
    {
      ...
      labels: ['first name', 'given name', 'what is your first name'],
      // Bare "Name" is Michael Page's first-name placeholder (Last Name is separate).
      placeholders: ['first name', 'given name', 'name']
    },
    {
      key: 'lastName',
      autocomplete: ['family-name'],
      names: ['lastname', 'last_name', 'last-name', 'lname', 'surname', 'familyname', 'family_name'],
      labels: ['last name', 'family name', 'surname', 'what is your last name'],
    ...
    },
    {
      ...
      labels: ['current location', 'where are you based', 'location (city'],
    ...
    },
    {
      ...
      labels: ['name title', 'salutation', 'courtesy title'],
    ...
    },
    {
      key: 'privacyAccepted',
      autocomplete: [],
      names: ['privacy_accepted', 'accept_data_privacy', 'privacy_consent', 'data_privacy', 'privacyAccepted'],
      labels: ['data privacy', 'privacy policy', 'privacy notice', 'accept data privacy', 'privacy'],
      placeholders: []
    },
    {
      key: 'driversLicense',
     ...
     */
    {
      key: 'experienceLevel',
      autocomplete: [],
      names: ['experience_level', 'experiencelevel', 'seniority', 'level'],
      labels: ['experience level', 'seniority', 'career level', 'what is your experience level'],
      placeholders: ['experience level', 'director', 'manager']
    },
    {
      key: 'sector',
      autocomplete: [],
  ...
  function scoreMatch(entry, descriptor) {
    ...
    (entry.names || []).forEach(function (p) {
      ...
      function nameHits(token) {
        ...
        // Avoid "title" matching inside "current_title" / "job_title"
        if (pn === 'title' && /(current|job|position|role)_?title/.test(token)) return false;
