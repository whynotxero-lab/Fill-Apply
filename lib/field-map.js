...
(function (global) {
  ...
  const FIELD_MAP = [
    ...
    },
    {
      ...
      labels: ['country', 'country of residence', 'what country do you live'],
    ...
    },
    {
      ...
      labels: ['nationality', 'citizenship', 'citizen of', 'for which country do you hold nationality', 'hold nationality'],
