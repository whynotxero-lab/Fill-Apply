...
(function (global) {
  ...
  function describeField(el) {
    ...
    if (type === 'radio') {
      // The option text ("0-2") is what labelFor returns for a wrapping
      // <label>. The question the group is asking is what we need to map.
      var question = groupQuestionFor(el);
