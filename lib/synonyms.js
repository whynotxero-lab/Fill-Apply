...
(function (global) {
  ...
  var APPLY_START_CTA =
    /\b(open\s*application|apply\s*now|start\s*apply|start\s*application|apply\s*for\s*this\s*(job|role|position)|apply\s*to\s*this\s*(job|role)|apply\s*here|apply)\b/i;
