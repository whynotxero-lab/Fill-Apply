...
(function (global) {
  ...
  var FAQ_ENTRIES = [
    ...
    },
    {
      ...
      strategy: 'CA-only (not CA/ACCA). Default No unless profile explicitly has ICAI CA. Never invent Yes.',
      controlHints: ['radio', 'select', 'text'],
      knownPolicy: 'PROFILE'
    },
    ...
    /* —— NaukriGulf / Easy Apply screening (intent-safe) —— */
    {
      key: 'basedInUae',
      category: 'screening',
      aliases: [
        ...
        'located in uae',
        'based in the uae',
        'open for in-person interview in dubai',
        'dubai difc interview'
      ],
      strategy: 'Yes/No from profile location. KSA/Riyadh → No. Never fill notice-period text into this question.',
      controlHints: ['radio', 'select', 'text'],
      knownPolicy: 'PROFILE'
    },
    {
      key: 'ifrsVatTaxExperience',
      category: 'screening',
      aliases: [
      ...
      strategy: 'Short finance experience blurb from skills/customAnswers/QB. NEVER city/country/notice tokens.',
      controlHints: ['textarea', 'text'],
      knownPolicy: 'PROFILE'
    },
    {
      key: 'soxAuditControlsExperience',
      category: 'screening',
      aliases: [
        'audit coordination',
        'sox',
      ...
      strategy: 'Short truthful FP&A/audit-support blurb from profile/QB. Leave blank → Complete Missing Information if unknown — never city/notice.',
      controlHints: ['textarea', 'text'],
      knownPolicy: 'PROFILE'
    },
    {
      key: 'bankingFsYearsEmployer',
      category: 'screening',
      aliases: [
        'years of experience in banking',
        'financial services and your most recent employer',
        'banking/financial services'
      ],
      strategy: 'Years + recent employer from profile. Prefer full sentence; never city alone.',
      controlHints: ['textarea', 'text'],
      knownPolicy: 'PROFILE'
    }
  ];
