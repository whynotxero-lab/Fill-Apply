 ...
 * Auto Apply (page panel): JobPool hub or Current page — always submit e2e.
...
(function (global) {
  ...
  const INJECT_FILES = [
    ...
    'adapters/boards/bayt.js',
    'adapters/boards/gulftalent.js',
  ...
  /** Abort flag for current-tab / Auto Apply runs (STOP). */
