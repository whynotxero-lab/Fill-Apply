...
**Version 1.17.3 (experimental)** — **integration release** combining the on-page Auto Fill / Ready / Submit panel (#2), adaptive applicant knowledge (#3), and ATS Google OAuth auth lifecycle (#4). One coherent experimental build on `grok/integration-experimental-release` — not yet merged to `main`.
